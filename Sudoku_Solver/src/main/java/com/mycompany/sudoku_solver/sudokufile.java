...
private String turn = "1";
   ...
   if(globalflag == true){
    ...
    for(int i=0;i<9;i++){
    for(int j=0; j<9; j++){
    if((btns[i][j].getText() == null ? solvedBoard[i][j] != null : !btns[i][j].getText().equals(solvedBoard[i][j])) && btns[i][j].getText() != ""){
    ...
    private void initComponents() {
        ...
        r2c5.setBackground(new java.awt.Color(0, 255, 255));
        r2c5.setText("7");
        ...
        resetbtn.setBackground(new java.awt.Color(204, 0, 153));
        ...
        solutionbtn.setBackground(new java.awt.Color(51, 255, 0));
        solutionbtn.setText("SOLUTION");
        ...
        movebtn.setBackground(new java.awt.Color(255, 255, 0));
        movebtn.setText("MOVE CHECK");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(movebtn, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(141, 141, 141)
                .addComponent(jButton93, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void r7c8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_r7c8ActionPerformed
        // TODO add your handling code here:\r1c2.setText(turn);
        r7c8.setText(turn);
